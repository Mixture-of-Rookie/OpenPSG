...
@HEADS.register_module()
class Mask2FormerMotifHead(RelationHead):
    def __init__(self, **kwargs):
        super(Mask2FormerMotifHead, self).__init__(**kwargs)
    ...
    def frontend_features(self, img_meta, det_result, gt_result):# {{{
        ...
        if gt_result is not None and gt_result.rels is not None:
            ...
            if len(sample_res) == 4:
                ...
                with open('segment_motifs_mask2former_r50_panoptic_0.8_num_rel_20_det', 'a+') as f:
