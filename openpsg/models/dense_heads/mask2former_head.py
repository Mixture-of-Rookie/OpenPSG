...
from .maskformer_head import PSGMaskFormerHead


@HEADS.register_module()
class PSGMask2FormerHead(PSGMaskFormerHead): 
    """Implements the Mask2Former head wrapped for Panoptic Scene Generation.
    ...
    def forward(self, feats, img_metas, return_query_feats=False):
        """Forward function.
