...
class PSGMaskFormerHead(AnchorFreeHead):
    """Implements the MaskFormer head wrapped for Panoptic Scene Generation.
    ...
    def simple_test(self, feats, img_metas, return_query_feats=False, **kwargs):
        ...
        """
        # len(all_cls_scores) = 10
        # len(all_mask_preds) = 10
        # len(all_query_feats) = 9
        ...
        if use_last_layer:
            ...
            up_mask_pred_results = F.interpolate(
                mask_pred_results,
