...
class MaskIoUAssigner(BaseAssigner):
    """Assign a corresponding gt mask or background to each mask.
    ...
    def assign(self, masks, gt_masks, gt_masks_ignore=None, gt_labels=None):
        """Assign gt to masks.
        This method assign a gt mask to every mask (proposal/anchor), each bbox
        ...
        """
        overlaps = mask_overlaps(gt_masks, masks, device=gt_labels.device)
